...
import com.bloom.exception.FileDownloadException;
import com.bloom.exception.FileUploadException;
import com.bloom.model.Agent;
import com.bloom.model.FileUploadResponse;
...
public class FileUploadDownloadService {
	...
	public String storeFile(MultipartFile file, String requestType, long num, int flag) {
		...
		if(flag == 0) { // 거래
			...
			fileName = maintenanceService.getMaintenanceByNum(num).getImage();
		} else { // 공인중개사 사진
