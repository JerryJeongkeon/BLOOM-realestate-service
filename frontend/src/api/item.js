...
//건물이력등록
function addBuliding(info) {
    // console.log("건물이력등록전 정보")
    // console.log(info)
...
// //이미지 불러오기
// function getImage(building, success) {
    
//     instance
//         .post("/api/image/", building)
//         .then(function (response) {
//             success(response)
//         })
//         .catch(error => {
...
function getblockDetail(address, dong, ho, success) {
    ...
    function getUserBlock(num, success) {
        ...
        //자기가 등록한 블록체인 등록한 내역 가져오기
        function addStateBuliding(info) {
           // console.log("상태 건물이력등록전 정보")
            //console.log(info)
